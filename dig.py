...
def digData():
    ...
    with requests.session() as s:
        ...
        # writeToCSV(fields,fileName_Supplier,companiesDetailSupplier)
    writeToCSV(fields,fileName_Buyer,companiesDetailBuyer)
...
def formateCompanies_supplier(companiesResult,companiesDetail):
        for company in companiesResult:
            ...
            postcode = company.get('postal_code')
            ...
            tempDic['city']=city
            tempDic['street']=street
            tempDic['postal_code']=postcode
